...
void EffectBlure_GetComputedValues(EffectBlure* this, s32 index, f32 ratio, Vec3s* vec1, Vec3s* vec2,
    ...
    if (this->flags & 0x10) {
        ...
        color1->r = func_800B0A24(p1Start.r, p1End.r, ratio);
        color1->g = func_800B0A24(p1Start.g, p1End.g, ratio);
        color1->b = func_800B0A24(p1Start.b, p1End.b, ratio);
        color1->a = func_800B0A24(p1Start.a, p1End.a, ratio);
        color2->r = func_800B0A24(p2Start.r, p2End.r, ratio);
        color2->g = func_800B0A24(p2Start.g, p2End.g, ratio);
        color2->b = func_800B0A24(p2Start.b, p2End.b, ratio);
        color2->a = func_800B0A24(p2Start.a, p2End.a, ratio);
    }
}
