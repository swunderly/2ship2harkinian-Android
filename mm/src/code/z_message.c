...
void Message_OpenText(PlayState* play, u16 textId) {
    ...
    if (!loadFromMessageTable) {
        // The message has already been loaded by a hook.
    } else if (msgCtx->textIsCredits) {
        ...
        case MSGMODE_NEW_CYCLE_0:
            ...
            if (gSaveContext.fileNum != 0xFF) {
                Sram_SetFlashPagesDefault(
                    &play->sramCtx, gFlashSaveStartPages[gSaveContext.fileNum * FLASH_SAVE_MAIN_MULTIPLIER],
        ...
        case MSGMODE_OWL_SAVE_0:
            ...
            if (gSaveContext.fileNum != 0xFF) {
                Sram_SetFlashPagesOwlSave(
                    &play->sramCtx, gFlashOwlSaveStartPages[gSaveContext.fileNum * FLASH_SAVE_MAIN_MULTIPLIER],
